...
//  every time a user opens a snap, the nav bar tint color of the FeedVC should switch colors between Blue and Yellow, while at the same time the background color of the LoginVC should also change between Yellow and Purple.
